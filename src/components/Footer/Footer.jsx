...
export default function Footer() {
    ...
    return <>
        <footer className='container px-24 pb-20  pt-12 bg-main-light'>
            ...
            <div className="flex sm:flex-col sm:space-y-4 md:flex-row justify-between items-center flex-wrap border-b-2 p-3">
            ...
            <div className="flex border-b-2 justify-between sm:flex-col md:flex-row">
