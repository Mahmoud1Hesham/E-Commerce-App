                            ...
                            <tr key={product.product.id} className="bg-white border-b hover:bg-gray-100 hover:scale-105 transition-all duration-500 ease-in-out shadow-md hover:shadow-lg">
                                ...
                                <td className="px-6 py-4">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            <span className="bg-gray-50 w-14 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block px-2.5 py-1 text-center "> {loading && product.product.id == productId ? <i class="fa-solid fa-spinner fa-spin-pulse"></i> : product.count}</span>
                                        </div>
